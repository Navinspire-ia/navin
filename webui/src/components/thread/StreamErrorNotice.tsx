  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-amber-500/10 px-3 py-2 text-[12px] leading-5 text-amber-700 dark:text-amber-300",
    ...
    >
      ...
      <Button
        ...
        className="h-6 w-6 shrink-0 text-current hover:bg-amber-500/15 hover:text-current"
      >
