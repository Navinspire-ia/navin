...
import type { ExecPolicyPayload } from "@/lib/types";
          ...
          <div className="min-w-0">
            ...
            <p className="text-[12px] leading-5 text-muted-foreground">
              {tx(
                ...
                "Block commands and file paths outside the active project folder by default.",
              )}
            </p>
          </div>
          <ToggleButton
          ...
          <div className="mt-2.5 space-y-1">
            ...
            <p className="px-0.5 pt-1 text-[11.5px] text-muted-foreground">
              {tx(
                ...
                "Always active. An allowed exception is the only way to bypass one of these.",
              )}
            </p>
          </div>
        ) : null}
