...
from navin.config.schema import AgentDefaults, ModelPresetConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        # NAVIN_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("NAVIN_MAX_CONCURRENT_REQUESTS", "3"))
