...
- ``to_json_schema()``: returns a dict compatible with :meth:`~navin.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~navin.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~navin.agent.tools.base.Schema`.
...
from navin.agent.tools.base import Schema
