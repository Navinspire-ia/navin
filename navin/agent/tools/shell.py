...
# Built-in deny rules, always active unless a command is explicitly allowed
# via ``allow_patterns``. ``label`` keys are i18n identifiers for the WebUI
# permissions panel.
...
class ExecTool(Tool):
    ...
    def apply_policy(
        ...
        *,
        ...
        self.deny_patterns = list(deny_patterns) + BUILTIN_DENY_PATTERNS
