...
from navin.providers.registry import PROVIDERS, create_dynamic_spec, find_by_name
...
_DOCS_LATEST_URL = "https://navin.wiki/docs/latest"
...
def _docs_payload() -> dict[str, Any]:
    ...
    base_url = f"https://navin.wiki/docs/{docs_version}"
    return {
