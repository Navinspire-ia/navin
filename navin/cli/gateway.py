...
from navin.gateway import (
    GatewayRuntime,
    GatewayRuntimePaths,
    GatewayStartOptions,
    GatewayStatus,
)
from navin.gateway.service import (
    GatewayServiceInstaller,
    GatewayServiceOptions,
    GatewayServiceResult,
    ServiceManagerKind,
)
from navin.webui.build import BuildMode
...
def create_gateway_app(
    *,
    ...
    gateway_app = typer.Typer(
        help="Start and manage the navin gateway.",
    ...
    def interactive_build_mode() -> BuildMode:
        # `navin gateway` is often launched by tests, supervisors, or service managers.
        # The higher-level `navin webui` command owns interactive first-run guidance.
        return "warn"
