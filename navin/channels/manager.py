...
from navin.utils.restart import (
    RestartNotice,
...
class ChannelInstanceSpec:
    """One runtime channel instance derived from config."""
...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import navin.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        from navin.channels.registry import discover_channel_names, discover_enabled
