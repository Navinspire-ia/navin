...
from navin.command.builtin import build_help_text
...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical navin commands."""
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm navin.\n\n"
    ...
    def _queue_key_for_message(message) -> str:
        """Return the final navin session key used for ordered Telegram ingress."""
