"""Career alerts use the common persistent delivery ledger."""
...
def deliver_alert(store: CareerStore | None, *, title: str, detail: str, level: str = "warn",
                  event_id: str = "", event_type: str = "alert", retry: bool = False) -> dict[str, Any]:
    try:
        result = deliver_event(store, module="career", title=title, detail=detail, level=level,
