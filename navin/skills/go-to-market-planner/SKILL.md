...
A launch is a coordinated moment, not a blog post. Plan segments, messages, assets, and sequencing.

## GTM checklist

| Block | Contents |
|-------|----------|
| Segments | who cares first (beachhead), who next |
| Messaging | value prop per segment, proof points, objections |
| Assets | landing page, demo, one-pager, FAQ, sales deck, emails |
| Channels | owned (site, email, social), earned (PR, partners), paid |
| Calendar | T-30 teaser → T-0 launch → T+30 follow-through |
| Enablement | sales scripts, pricing, objection handling |
| Metrics | signups, demos, pipeline, activation |
