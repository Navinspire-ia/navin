...
Same message, different skin. Transform tone, rhythm, and vocabulary while preserving every fact and commitment.

## Style dimensions

| Dimension | Spectrum |
|-----------|----------|
| Formality | institutionnel ↔ conversationnel |
| Energy | sobre ↔ enthousiaste |
| Density | détaillé ↔ percutant |
| Distance | corporate "nous" ↔ personnel "je" |
| Vocabulary | technique ↔ grand public |
...
- Substance is sacred: no new claims, no dropped caveats.
- If the target style would make the message dishonest or unclear, say so.
- Keep the output language identical to the source unless asked (`translation-localization` for language changes).
