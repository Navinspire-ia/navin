"""High-level programmatic interface to navin."""
...
from navin.sdk.clients import MemoryClient, RuntimeClient, SessionClient
from navin.sdk.runtime import (
    build_process_direct_kwargs,
    ensure_single_model_selector,
)
from navin.sdk.streaming import RunStream, SDKStreamEmitter, SDKStreamingHook
from navin.sdk.types import (
...
class Navin:
    """Programmatic facade for running the navin agent.

    Usage::

        bot = Navin.from_config()
    ...
    async def __aenter__(self) -> Navin:
        return self
