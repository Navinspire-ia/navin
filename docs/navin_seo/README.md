...
| Page | Contents |
| --- | --- |
| [Overview](./en/README.md) | The module, the `/seo` command, workflows |
| [Actions](./en/actions.md) | The 12 studio actions in detail |
| [Skills](./en/skills.md) | SEO skills |

## Français

| Page | Contenu |
| --- | --- |
| [Vue d'ensemble](./fr/README.md) | Le module, la commande `/seo`, les workflows |
| [Actions](./fr/actions.md) | Les 12 actions du studio en détail |
| [Skills](./fr/skills.md) | Skills SEO |
