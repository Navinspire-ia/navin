...
| Action | Livre |
| --- | --- |
| Recherche de mots-clés | Expansion de seeds, classification d'intention (informationnelle/commerciale/transactionnelle), estimations de difficulté et de valeur, regroupés en clusters et priorisés dans un tableau enregistré en fichier. |
| Plan de contenu & clusters | Pages piliers et articles de soutien par cluster, mot-clé cible et intention pour chacun, plan de maillage interne, ordre de publication par impact. |
| Questions & intentions | Questions posées par les utilisateurs (type « autres questions posées », forums, recherches associées), listées par intention, associées à un format de contenu, avec les gains rapides mis en avant. |
| SEO local | Checklist d'optimisation de la fiche d'établissement, mots-clés locaux cibles, stratégie de citations et d'avis, structure de landing pages localisées, plan de suivi. |
